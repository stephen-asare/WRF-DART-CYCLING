...
## Purpose
WRF is the core numerical weather prediction system. It ingests the meteorological boundary conditions generated by WPS and performs the atmospheric simulations required for the Observation System Simulation Experiment (OSSE).
...
```
Navigate into the WRF directory and configure:
