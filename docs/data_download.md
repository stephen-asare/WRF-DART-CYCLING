...
```
Now, if you do not have an account at ECMWF Climate Data Store, please [register][register](https://cds.climate.copernicus.eu/how-to-api#)) one, if you have simply [login]([login](https://cds.climate.copernicus.eu/how-to-api#). Then Once you log in from here, copy the code that would be displaced. Create file `cdsapirc` in your home directory and paste the code into the file `$HOME/.cdsapirc`
```
