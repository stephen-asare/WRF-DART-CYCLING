...
if [[ $NUM_PROCS -gt 1 ]]; then
   ...
   export RUN_CMD="--partition=chipilskigroup_q --cpus-per-task=24"
fi
export CLEAN=false
...
# cp /gpfs/home/sa24m/scratch/tqprof/run2/osse_out/icbc/$DATE/wrfbdy_d01_00_18 ${RC_DIR_SAVE}/${DATE_SAVE}/wrfbdy_d01

ln -sf /gpfs/research/scratch/sa24m/tqprof/run2/osse_out/icbc/2015071300_2015071518/wrfbdy_d01_00_18 $REAL_DIR/$INITIAL_DATE/wrfbdy_d01
ln -sf /gpfs/research/scratch/sa24m/tqprof/run2/osse_out/icbc/2015071300_2015071518/wrfinput_d01_00_18 $REAL_DIR/$INITIAL_DATE/wrfinput_d01.2015-07-13_00:00:00
