...
#set BUFR_dir = ../data
#set BUFR_dir  = /glade/work/junkyung/MYing_work/data/ds337.0
set BUFR_dir  = /glade/derecho/scratch/junkyung/sshohan/bufr_data

set BUFR_idir = ${BUFR_dir}
#set BUFR_odir = ${BUFR_dir}/prepout
set BUFR_odir = /glade/derecho/scratch/junkyung/sshohan/prep_bufr/work/prepout


# directory where DART prepbufr programs are located, relative to here.
#set DART_exec_dir = ../../exe
set DART_exec_dir = /glade/work/junkyung/MYing_work/code/DART-Manhattan/observations/obs_converters/NCEP/prep_bufr/exe
...
while ( $hr_file <= $files_per_day )
   ...
   set BUFR_in = ${BUFR_idir}/prepbufr.gdas.20${sdtg_new}.nr
   #set BUFR_in = ${BUFR_idir}/${year}${mn}${dy}${hr}.rap.t${hr}z.prepbufr.tm00
