...
export PROJECT=${PROJECT:-48500047}
...
export NL_CV_OPTIONS=${NL_CV_OPTIONS:-3} # jkjk
...
export NV=${NV:-16}                                    # Number of ETKF variables.
export CV=${CV:-"'U'", "'V'", "'W'", "'PH'", "'T'", "'MU'", "'TSLB'", "'TSK'", \
                "'QCLOUD'", "'QRAIN'", "'QVAPOR'", "'U10'", "'V10'", "'T2'", "'Q2'", "'PSFC'"} # ETKF variable names
