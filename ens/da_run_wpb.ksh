...
export SCRIPTS_DIR=${SCRIPTS_DIR:-$WRFVAR_DIR/var/scripts/RC_ICBDY_ptb/july15_mod_as4_30h/d01}
echo "wpb = " ${SCRIPTS_DIR}
...
while [[ $MEM -le $NUM_MEMBERS ]]; do 
   echo "Producing perturbed wrfic files for ensemble member $MEM"
   $SCRIPTS_DIR/da_perturb_wrf_ic.ksh > ${RUN_DIR}/da_perturb_wrf_ic_d01.${MEM}.out 2>&1 &
